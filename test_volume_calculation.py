...
if __name__ == "__main__":
    ...
    [recall_gains, areas] = rgrpg.build_rgrpg_surface(step1_labels, step1_scores, step2_labels, step2_scores)
    print rgrpg.calculate_volume(recall_gains, areas)
    rgrpg.plot_rgrpg_2d(recall_gains, areas)
